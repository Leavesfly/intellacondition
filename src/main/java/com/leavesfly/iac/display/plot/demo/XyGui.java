...
public class XyGui extends ApplicationFrame {
	...
	public static void main(String[] args) {
		XyGui gui = new XyGui("sss", new double[] { 1, 2, 1, 4, 5 }, new double[] { 1, 2, 3, 4, 5 });
		gui.plot();
	}
	...
	public XyGui(String title, double[] x, double[] y) {
		...
		if (checkX(x) && checkY(x.length, y)) {
			...
			final JFreeChart chart = ChartFactory.createXYLineChart("XY Series", "X", "Y",
	 ...
	 */
	public XyGui(String title, String nameForData1, String nameForData2, String[] items,
		...
		final JFreeChart chart = ChartFactory.createLineChart("User Similarity", "Items", "Rating",
